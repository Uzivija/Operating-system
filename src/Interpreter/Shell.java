...
public class Shell {
    ...
    public static User_List user_list = new User_List();
    static IPC ipc;
    ...
    public static User_List getUserList() {return user_list;}
    ...
    private void addAllCommands()
    {
        ...
        allCommands.put("CREATE_LINK" , "Tworzy dowiązanie do pliku");
        argCommands.put("CREATE_LINK" , "[Nazwa pliku] [Nazwa dowiązania] ");
        ...
        argCommands.put("INODE_FILE" , "[Nazwa pliku]");

        allCommands.put("INODE_TAB" , "Wyświetla tablice i-węzłów");
        argCommands.put("INODE_TAB" , " ");

        allCommands.put("BIT","Wyświetla tablice bitów na dysku");
        argCommands.put("BIT", " ");
        ...
        allCommands.put("CHANGE_FILE_PERM" , "Zmienia uprawnienia w pliku dla danego użytkownika");
        ...
        argCommands.put("DELETE_USER", "[Nazwa użytkownika]");
        ...
        argCommands.put("PCB" , "[Nazwa procesu]");
        ...
        //printQueue()
        allCommands.put("PAGE_FILE","Wyświetla stronnice dla procesu");
        argCommands.put("PAGE_FILE","[ID procesu] lub pozostaw puste aby wyświetlić wszystkie");

        allCommands.put("VM_RAM","Wyświetla aktualny stan ramu");
        argCommands.put("VM_RAM"," ");
    ...
    private void read()
    {
        ...
        switch (command[0])
        {
                ...
                if(command.length == 4)
                {
                    ...
                    if(perm != null)
                    {
                        try{
                            ...
                            //System.out.println("Dodano uzytkownika do listy uprawnien");
                        }
                        catch(NumberFormatException e )
                        {
                            command_check(command,argCommands);
            ...
            case "NEW_USER": {
                if(command.length == 3)
                {
                    try
                    {
                        ...
                        for(Map.Entry<String, File> e : disc.catalog.entrySet())
                        {
                            int n = e.getValue().number;
                            Disc.getInodeTableInstance()[n].permissions.changeParam(command[1],2);
                        }
                    }
                    catch (Exception e)
                    {
            ...
            default: {
                ...
                System.out.println("Aby uzyskać pomoc wpisz MAN ");
                break;
            }
        }
    }
